import 'package:weather_mvvm_clean/features/weather/data/models/daily_model.dart';
import 'package:weather_mvvm_clean/features/weather/data/models/hourly_model.dart';
...
class ForecastModel {
  ...
  Forecast toEntity() =>
      Forecast(hourly: hourly.map((hour) => hour.toEntity()).toList(), daily: daily.map((day) => day.toEntity()).toList());
}
